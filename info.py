...
BOT_TOKEN = environ.get('BOT_TOKEN', '7651386987:AAEj7JGMXy56ODiYdz0ALvV89Pjj503ktJs')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002466122115'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/AtoZFilmssGroup')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002242275783').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Anidutta124:Anidutta124@anidutta124.ywklb.mongodb.net/?retryWrites=true&w=majority&appName=Anidutta124")
DATABASE_NAME = environ.get('DATABASE_NAME', "Anidutta124")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002338885297')
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/14554cfd72bcc076cb64a-58f4e8386e4efb87e8.jpg')).split()
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/45e7b7535c312d964c7a6-7c4aaa5e9d4deda0ba.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "😈", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
