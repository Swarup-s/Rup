...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rup:rup@rup.1hyso.mongodb.net/?retryWrites=true&w=majority&appName=Rup")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rup")
